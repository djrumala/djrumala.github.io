...
Enter Jekyll for academic blogs. I believe it's the most convenient platform for researchers, whether for your portfolio or any other needs. Initially, I didn't take it seriously and edited everything directly on GitHub. Sounds crazy, considering my aversion to additional installations for local website running. But somehow, it's been worth it.
...
💡 <b> Some advice </b>: For me, visual studio code is the best app for managing and writing codes. When I first learned how to build a website, I used notepad++ 😅 That is okay, if you happen to do that now.
But, rest assured, visual studio code is not that hard, rather it is so convinient. So, if you have the time to learn it or install it if you have not, go for it! I am sure this will not take a lot of time.
...
💡 <b>Please note</b>: that you need to restart jekyll server with this command every time you modify `_config.yml` and when you do modify this file, please also make sure that you also modify `_config.dev.yml`
